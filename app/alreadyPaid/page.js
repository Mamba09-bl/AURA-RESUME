...
export default function AlreadyPaidPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0b0f19] px-6">
      <div
        className="w-full max-w-xl bg-gray-900/60 backdrop-blur-xl
        border border-gray-800 rounded-3xl shadow-2xl p-10 text-center"
      >
        {/* Badge */}
        <div
          className="inline-flex items-center gap-2 px-4 py-1.5 mb-6
          rounded-full bg-indigo-500/10 border border-indigo-500/20"
        >
        ...
        <div
          ...
          text-indigo-300 font-semibold p-4 rounded-2xl mb-10"
        >
